# -*- coding: utf-8 -*-
# Generated by Django 1.11.5 on 2017-11-17 12:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('client', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='request_quote.Client')),
            ],
        ),
        migrations.CreateModel(
            name='Transport',
            fields=[
                ...
                ('commodity', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='request_quote.Commodity')),
            ],
        ),
    ]
